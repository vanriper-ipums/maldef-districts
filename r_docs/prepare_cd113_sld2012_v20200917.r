# prepare_cd113_sld2012_v20200917.r
...
sf <- fread("/pkg/ipums/misc/census-das/ppmf-tabs-20200917/data/sf1/nhgis1364_csv/sf_nhgis1364_ds172_2010_block.csv.gz", sep = ",")
...
#### Write out to CSV #### 
fwrite(congress2013, "data/congress2013_v20200917.csv")
fwrite(lowerSLD2012, "data/lowerSLD2012_v20200917.csv")
fwrite(upperSLD2012, "data/upperSLD2012_v20200917.csv")